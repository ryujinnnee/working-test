...
const DarkModeToggle = () => {
  ...
  return (
    <div id="themmm">
      <input id="checkbox" type="checkbox" onClick={toggleDarkMode}/>
      ...
      {/* <button
        ...
        className="p-2 bg-primary dark:bg-bag-primary-dark text-black dark:text-text-white"
      >
        <span>Light/Darks </span>
      </button> */}
    </div>
  );
};
