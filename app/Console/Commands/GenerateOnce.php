...
class GenerateOnce extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:generate-once';
    ...
    public function handle()
    {
        try {
            ...
            $tagihan = tagihan_master::where('quant', 'once')->get(); // Ambil tagihan tahunan (sekali setahun)
